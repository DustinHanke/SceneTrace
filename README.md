...
Install `scenetrace-blender-1.0.3.zip` using Blender 4.2+:
...
Release archives provide Windows, Linux, and macOS CLI binaries plus SHA-256 checksums; Rust is only needed for source builds. Install `scenetrace-blender-1.0.3.zip` in Blender 4.2+ for the interactive extension. The supported headless CLI/CI version for 1.0 is Blender 4.4.
